...
public class TraceDecodedBlocks
{
    ...
    public void TraceFirstFewBlocks()
    {
        ...
        for (var i = 0; i < Math.Min(20, blocks[0].Length); i++)
        {
        ...
        for (var i = 38; i < Math.Min(45, blocks[0].Length); i++)
        {
            int blockX = i % 38;
            int blockY = i / 38;
            int pixelX = blockX * 8;
        ...
        for (var c = 0; c < frame.ComponentCount; c++)
        {
            ...
            for (var b = 0; b < dequantBlocks[c].Length; b++)
            {
    ...
    public void CompareDecodeOrderWithLayout()
    {
        ...
        for (var mcuY = 0; mcuY < 3; mcuY++)
        {
            ...
            for (var mcuX = 0; mcuX < 3; mcuX++)
            {
                ...
                for (var subY = 0; subY < vSamp; subY++)
                {
                    for (var subX = 0; subX < hSamp; subX++)
                    {
