...
/// </summary>
public interface ICodestreamParser : IPipelineStage<byte[], Jp2Codestream>
{
}
...
/// </summary>
public interface ITier2Decoder : IPipelineStage<Jp2TilePart, Tier2Output>
{
}
...
/// </summary>
public interface ITier1Decoder : IPipelineStage<CodeBlockBitstream, int[,]>
{
}
...
/// </summary>
public interface IDequantizer : IPipelineStage<QuantizedSubband, double[,]>
{
}
...
/// </summary>
public interface IInverseDwt : IPipelineStage<DwtCoefficients, double[,]>
{
}
...
/// </summary>
public interface IPostProcessor : IPipelineStage<ReconstructedTile, byte[]>
{
}
