...
public class CodingParameters
{
    ...
    public CodingStyle Style { get; init; }
    ...
    public int MultipleComponentTransform { get; init; }
...
public class QuantizationParameters
{
    ...
    public QuantizationStyle Style { get; init; }
    ...
    public QuantizationStepSize[] StepSizes { get; init; } = [];
}
...
/// </summary>
public record struct QuantizationStepSize(int Exponent, int Mantissa)
{
    /// <summary>
