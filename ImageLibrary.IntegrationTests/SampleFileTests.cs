...
public class SampleFileTests
{
    ...
    public void DecodeBmpFile(string filePath)
    {
        ...
        try
        {
            ...
            _output.WriteLine($"OK: {relativePath} ({image.Width}x{image.Height})");
        ...
        {
            // For unexpected failures, report but don't fail the test
            // as test suites may contain edge cases we don't support yet
